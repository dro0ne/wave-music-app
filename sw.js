const CACHE='wave-shell-v7';
const SHELL=['./','./index.html','./styles.css?v=7','./recommendation-config.js?v=3','./recommendation-engine.js?v=3','./app.js?v=12','./manifest.webmanifest?v=3','./wave-icon.svg'];
