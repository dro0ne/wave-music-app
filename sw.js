const CACHE='wave-shell-v8';
const SHELL=['./','./index.html','./styles.css?v=7','./recommendation-config.js?v=4','./recommendation-engine.js?v=4','./app.js?v=13','./manifest.webmanifest?v=3','./wave-icon.svg'];
