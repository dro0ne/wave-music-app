const CACHE='wave-shell-v9';
const SHELL=['./','./index.html','./styles.css?v=7','./recommendation-config.js?v=5','./recommendation-engine.js?v=5','./app.js?v=14','./manifest.webmanifest?v=3','./wave-icon.svg'];
